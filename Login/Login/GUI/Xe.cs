...
namespace Login
{
    public partial class Xe : Form
    {
        ...
        string connString = "Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST= 172.16.93.200)(PORT=1521))(CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME=orcl21)));Password=123;User ID=HR";
        public Xe()
        {
            InitializeComponent();
        }
